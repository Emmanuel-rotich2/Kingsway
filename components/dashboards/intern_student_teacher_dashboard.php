<?php
// Intern/Student Teacher Dashboard
...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0"><i class="bi-person-workspace me-2"></i>Intern/Student Teacher Dashboard</h2>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header" style="background-color: #20c997; color: white;">
                    <h5 class="mb-0"><i class="bi-person-workspace me-2"></i>Dashboard Content</h5>
                </div>
                <div class="card-body">
