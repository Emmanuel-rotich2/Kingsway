...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0"><i class="bi-droplet me-2"></i>Cleaner/Janitor Dashboard</h2>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header" style="background-color: #17a2b8; color: white;">
                    <h5 class="mb-0"><i class="bi-droplet me-2"></i>Dashboard Content</h5>
                </div>
                <div class="card-body">
