 ...
 * Template for recognizing excellence in sports and athletics
 * 
 ...
 * - $sportsCoordinatorName: Sports coordinator name
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Sports Achievement Certificate</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 0;
...
<body>
    <div class="certificate">
        <div class="watermark">CHAMPION</div>
        ...
        <div class="certificate-title">Certificate of Sports Achievement</div>
        ...
        <div class="certificate-body">
            ...
            <div class="achievement-text">
                In recognition of <strong>outstanding athletic performance</strong> 
                and <strong>excellence in sportsmanship</strong> during the 
                <strong><?= $academicYear ?> Academic Year</strong>.
            </div>
            <div class="achievement-text">
                Awarded for <strong><?= $achievement ?></strong>
                in <strong><?= $sport ?></strong>
            </div>
        </div>
        ...
        <div class="certificate-footer">
            ...
            <div class="signature-section">
                <div class="signature-line"></div>
                <div class="signature-label"><?= $sportsCoordinatorName ?></div>
                <div class="signature-title">Sports Coordinator</div>
            </div>
        </div>
