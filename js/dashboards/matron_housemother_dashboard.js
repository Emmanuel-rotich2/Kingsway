/**
 * Matron/Housemother Dashboard Controller
 * Manages Matron/Housemother dashboard using api.js for real-time data
 */

const matronDashboardController = {
    dashboardData: {},
    ...
    init: function() {
        ...
        console.log('Matron/Housemother Dashboard initialized');
    },
    ...
    loadDashboardData: async function() {
        ...
        this.isLoading = true;
        try {
            const stats = await window.API.apiCall('/dashboard/matron/students', 'GET');
            if (stats) {
                this.dashboardData.stats = stats;
                this.updateStatistics();
            }
            
            const additionalData = await window.API.apiCall('/dashboard/matron/boarding', 'GET');
            if (additionalData) {
    ...
    exportDashboardData: function() {
        try {
            const data = {
                dashboard: 'Matron/Housemother Dashboard',
...
document.addEventListener('DOMContentLoaded', () => matronDashboardController.init());
