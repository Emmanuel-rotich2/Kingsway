 ...
 * Manages Catering Manager dashboard using api.js for real-time data
 */
...
const cateringDashboardController = {
    ...
    init: function() {
        ...
        console.log('Catering Manager Dashboard initialized');
    },
    ...
    loadDashboardData: async function() {
        ...
        this.isLoading = true;
        try {
            const stats = await window.API.apiCall('/dashboard/catering/stats', 'GET');
            if (stats) {
                this.dashboardData.stats = stats;
                this.updateStatistics();
            }
            
            const additionalData = await window.API.apiCall('/dashboard/catering/menu', 'GET');
            if (additionalData) {
    ...
    exportDashboardData: function() {
        try {
            const data = {
                dashboard: 'Catering Manager Dashboard',
