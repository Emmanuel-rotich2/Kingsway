 ...
 * Manages Intern/Student Teacher dashboard using api.js for real-time data
 */
...
const internDashboardController = {
    ...
    loadDashboardData: async function() {
        ...
        this.isLoading = true;
        try {
            const stats = await window.API.apiCall('/dashboard/intern/classes', 'GET');
            if (stats) {
                this.dashboardData.stats = stats;
                this.updateStatistics();
            }
            
            const additionalData = await window.API.apiCall('/dashboard/intern/attendance', 'GET');
            if (additionalData) {
    ...
    exportDashboardData: function() {
        try {
            const data = {
                dashboard: 'Intern/Student Teacher Dashboard',
