...
window.StaffAccess = (() => {
  ...
  const legacyAliases = {
    ...
    'staff.appointments.approve': ['staff_appointments_approve', 'staff_appointments_manage', 'staff_lifecycle_approve'],
    'staff.appointments.onboard': ['staff_onboarding_manage', 'staff_create', 'staff_update'],
