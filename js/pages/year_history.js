const YearHistoryController = (() => {
    ...
    async function loadData() {
        try {
            const r = await window.API.apiCall('/academic/year-history', 'GET');
            allData = r?.data || r || [];
    ...
    function renderStats(data) {
        ...
        document.getElementById('statPerformance').textContent = items.length;
        document.getElementById('statGraduation').textContent = items.length;
    }
    ...
    function exportCSV() {
        ...
        const a = document.createElement('a'); a.href = URL.createObjectURL(new Blob([csv],{type:'text/csv'})); a.download = 'year_history.csv'; a.click();
    }
