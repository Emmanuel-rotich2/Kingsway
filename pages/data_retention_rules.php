<?php /** Data Retention Rules - Configure data retention policies */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-database me-2"></i>Data Retention Rules</h4><p class="text-muted mb-0">Configure data retention policies</p></div>
...
<script>window._logCtrl = new LogViewerController({ title: 'Data Retention Rules', apiEndpoint: '/system/data-retention-rules' });</script>