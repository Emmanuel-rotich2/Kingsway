<?php /** Permission Changes - Track permission and access changes */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-exchange-alt me-2"></i>Permission Changes</h4><p class="text-muted mb-0">Track permission and access changes</p></div>
...
<script>window._logCtrl = new LogViewerController({ title: 'Permission Changes', apiEndpoint: '/system/permission-changes' });</script>