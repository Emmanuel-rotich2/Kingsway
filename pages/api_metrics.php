<?php /** API Metrics - View API usage metrics */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-chart-area me-2"></i>API Metrics</h4><p class="text-muted mb-0">View API usage metrics</p></div>
...
<script>window._logCtrl = new LogViewerController({ title: 'API Metrics', apiEndpoint: '/system/api-metrics' });</script>