<?php /** Cache Monitor - Monitor cache utilization */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-memory me-2"></i>Cache Monitor</h4><p class="text-muted mb-0">Monitor cache utilization</p></div>
    ...
    <div class="card shadow-sm"><div class="card-header bg-white"><h6 class="mb-0"><i class="fas fa-memory me-2"></i>Cache Monitor Details</h6></div><div class="card-body"><div id="monitorContent" class="text-center text-muted py-4">Loading monitoring data...</div></div></div>
</div>
<script src="/Kingsway/js/pages/system/monitoring_controller.js?v=<?php echo time(); ?>"></script>
<script>window._monCtrl = new MonitoringController({ title: 'Cache Monitor', apiEndpoint: '/system/cache', refreshInterval: 30000 });</script>