<?php /** Policy Violations - Monitor policy violation events */ ?>
<div class="container-fluid py-4">
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-gavel me-2"></i>Policy Violations</h4><p class="text-muted mb-0">Monitor policy violation events</p></div>
...
<script>window._logCtrl = new LogViewerController({ title: 'Policy Violations', apiEndpoint: '/system/policy-violations' });</script>