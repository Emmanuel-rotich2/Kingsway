<?php /** Force Logout - Force logout user sessions */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-sign-out-alt me-2"></i>Force Logout</h4><p class="text-muted mb-0">Force logout user sessions</p></div>
    ...
    <div class="card shadow-sm"><div class="card-header bg-white"><h6 class="mb-0"><i class="fas fa-sign-out-alt me-2"></i>User / Session Matrix</h6></div><div class="card-body" id="matrixContainer"><div class="text-center text-muted py-4">Loading matrix...</div></div></div>
</div>
<script src="/Kingsway/js/pages/system/matrix_grid_controller.js?v=<?php echo time(); ?>"></script>
<script>window._matrixCtrl = new MatrixGridController({ title: 'Force Logout', apiEndpoint: '/system/force-logout', rowLabel: 'User', colLabel: 'Session' });</script>