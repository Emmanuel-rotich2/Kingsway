<?php /** System Diagnostics - Run system diagnostics */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-stethoscope me-2"></i>System Diagnostics</h4><p class="text-muted mb-0">Run system diagnostics</p></div>
