...
$pageDescription = 'Manage parent/guardian family groups and student relationships';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-1"><i class="fas fa-users me-2"></i><?= $pageTitle ?></h2>
                <p class="text-muted mb-0"><?= $pageDescription ?></p>
            </div>
            <div class="btn-group">
                <button class="btn btn-primary" onclick="FamilyGroupsController.showCreateParentModal()">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" onclick="FamilyGroupsController.showLinkChildModal()">
