<?php /** Job Queue Monitor - Monitor job queue */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-tasks me-2"></i>Job Queue Monitor</h4><p class="text-muted mb-0">Monitor job queue</p></div>
    ...
    <div class="card shadow-sm"><div class="card-header bg-white"><h6 class="mb-0"><i class="fas fa-tasks me-2"></i>Job Queue Monitor Details</h6></div><div class="card-body"><div id="monitorContent" class="text-center text-muted py-4">Loading monitoring data...</div></div></div>
</div>
<script src="<?= $appBase ?>js/pages/system/monitoring_controller.js?v=<?php echo time(); ?>"></script>
<script>window._monCtrl = new MonitoringController({ title: 'Job Queue Monitor', apiEndpoint: '/system/job-queue', refreshInterval: 30000 });</script>