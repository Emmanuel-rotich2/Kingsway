<?php /** Activity Audit Logs - View detailed user activity audit trail */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-clipboard-list me-2"></i>Activity Audit Logs</h4><p class="text-muted mb-0">View detailed user activity audit trail</p></div>
...
<script>window._logCtrl = new LogViewerController({ title: 'Activity Audit Logs', apiEndpoint: '/system/activity-audit-logs' });</script>