<?php /** Data Retention - Monitor data retention */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-archive me-2"></i>Data Retention</h4><p class="text-muted mb-0">Monitor data retention</p></div>
