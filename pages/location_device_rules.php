<?php /** Location & Device Rules - Manage location/device rules */ ?>
<div>
    <div class="row mb-4"><div class="col-12"><div class="d-flex justify-content-between align-items-center">
        <div><h4 class="mb-1"><i class="fas fa-map-marker-alt me-2"></i>Location & Device Rules</h4><p class="text-muted mb-0">Manage location/device rules</p></div>
    ...
    <div class="card shadow-sm"><div class="card-header bg-white"><h6 class="mb-0"><i class="fas fa-map-marker-alt me-2"></i>Location & Device Rules Settings</h6></div><div class="card-body" id="settingsContainer"><div class="text-center text-muted py-4">Loading settings...</div></div></div>
</div>
<script src="/Kingsway/js/pages/system/toggle_config_controller.js?v=<?php echo time(); ?>"></script>
<script>window._toggleCtrl = new ToggleConfigController({ title: 'Location & Device Rules', apiEndpoint: '/system/location-device-rules' });</script>