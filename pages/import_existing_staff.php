...
<div class="container-fluid py-4" id="staffMigrationPage">
  <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
    <div><h3 class="mb-1"><i class="bi bi-people-fill me-2 text-primary"></i>Existing Staff Migration</h3><p class="text-muted mb-0">Validate the complete CSV before creating staff, user accounts, roles and invitation emails.</p></div>
    <div class="d-flex gap-2"><button id="smTemplate" class="btn btn-outline-primary"><i class="bi bi-download me-1"></i>CSV Template</button><button id="smRefresh" class="btn btn-outline-secondary"><i class="bi bi-arrow-clockwise"></i></button></div>
  </div>
  ...
  <div class="row g-4">
    <div class="col-lg-5"><div class="card shadow-sm border-0"><div class="card-body">
      <label class="form-label fw-semibold" for="smFile">Completed staff CSV</label><input id="smFile" class="form-control" type="file" accept=".csv">
...
<script src="<?= $appBase ?>/js/pages/import_existing_staff.js"></script>
