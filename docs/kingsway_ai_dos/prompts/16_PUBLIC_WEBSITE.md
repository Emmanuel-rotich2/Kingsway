# CODEX IMPLEMENTATION PROMPT — Public Website and Content Pages
...
Complete public-facing pages only after core ERP flows are stable. Public pages must not depend on protected API data and must not expose internal system errors.
...
- downloads.php
- public/
- api/controllers/Public/Website-related controllers if any


## MVP workflows that must work

MVP workflows:
1. Visitor opens public homepage/about/contact.
2. Visitor views news/events/careers if content exists.
3. Contact form submits safely or shows honest unavailable state.
4. No protected system data leaks publicly.
...
Create/update:
- docs/AI_DOS/PUBLIC_WEBSITE_IMPLEMENTATION_NOTES.md
- docs/AI_DOS/PUBLIC_WEBSITE_TESTING_CHECKLIST.md

Implement:
- remove placeholder public content from MVP pages
- safe public API/content loading
- graceful 404/empty states
