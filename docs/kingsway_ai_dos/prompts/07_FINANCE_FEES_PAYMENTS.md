# CODEX IMPLEMENTATION PROMPT — Finance, Fee Structure, Fees, Payments
...
Complete the finance MVP: fee structure drafting/approval, student billing, payment recording/reconciliation, fee balances, defaulters, and basic finance reports.
...
- pages/finance/
- pages/fee_structure/
- pages/manage_fee_structure.php
- pages/manage_fees.php
- js/pages/*fee*.js
- js/pages/*finance*.js
- js/pages/*payment*.js
- api/controllers/FinanceController.php
- api/controllers/PaymentsController.php
- api/controllers/AccountsController.php
- api/modules/finance/
- api/modules/payments/
- finance, fees, payments, invoices, bank database tables
- SECURITY_FIXES_2026_06_25.md


## MVP workflows that must work

MVP workflows:
1. Accountant drafts fee structure.
2. Director/Headteacher approves fee structure.
3. System bills students by class/term.
4. Accountant records payment.
5. System updates balances.
6. View defaulters.
7. Parent/student sees own balance.
8. Finance reports show real totals.
9. Payment webhooks remain secure.
...
Create/update:
- docs/AI_DOS/FINANCE_WORKFLOW_SPEC.md
- docs/AI_DOS/FINANCE_TESTING_CHECKLIST.md

Implement:
- canonical fee structure workflow
- billing and balances using real tables
- payment recording and validation
- report endpoints and UI
- permission separation: accountant drafts, director approves, viewer reads
- audit logs for payments/approvals/adjustments
