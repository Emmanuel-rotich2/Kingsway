# CODEX IMPLEMENTATION PROMPT — MVP QA and Release Hardening
...
After module implementation, harden the system for MVP release: remove placeholder MVP paths, verify routes, verify JS loading, verify API permissions, and write release checklist.
...
MVP workflows:
1. Every sidebar URL opens a valid page or is removed.
2. Every interactive page loads its JS controller.
3. Every protected API requires auth and permission.
4. Every role can complete its main workflows.
5. No MVP page uses mock/dummy/placeholder data.
...
Create/update:
- docs/AI_DOS/MVP_RELEASE_CHECKLIST.md
- docs/AI_DOS/REGRESSION_TEST_PLAN.md
- docs/AI_DOS/KNOWN_LIMITATIONS.md
