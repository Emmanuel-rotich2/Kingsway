# CODEX IMPLEMENTATION PROMPT — Transport Module
...
Complete transport MVP: vehicles, drivers, routes, stops, student assignment to route, transport billing handoff if present, and basic transport status.

## Primary files and areas to inspect first

Inspect:
- pages/transport/
- pages/manage_transport.php
- js/pages/*transport*.js
- api/controllers/TransportController.php
- api/modules/transport/
- api/modules/Finance/TransportBillingManager.php
- transport, vehicles, drivers, routes, stops database tables
...
1. Manage vehicles.
2. Manage drivers.
3. Manage routes and stops.
4. Assign student to route/stop.
5. View transport list/status.
6. Driver sees assigned route if role exists.
7. Accountant can see billing-related transport assignments if supported.
...
Create/update:
- docs/AI_DOS/TRANSPORT_IMPLEMENTATION_NOTES.md
- docs/AI_DOS/TRANSPORT_TESTING_CHECKLIST.md

Implement:
- canonical transport admin page/controller
- real route/vehicle/driver APIs
- student route assignment
- scoped role visibility
- no fake GPS unless real data source exists
