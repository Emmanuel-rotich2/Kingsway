# CODEX IMPLEMENTATION PROMPT — Reports, Audit, Exports
...
Complete MVP reporting layer and audit visibility across the core modules that are already implemented. Reports must not calculate from fake data.

## Primary files and areas to inspect first

Inspect:
- api/controllers/ReportsController.php
- api/controllers/AuditController.php
- api/modules/reports/
- pages/*report*.php
- js/pages/*report*.js
- audit_logs/audit_trail database tables


## MVP workflows that must work

MVP workflows:
1. Director/Admin views core reports.
2. Accountant views finance reports.
3. Teacher views class/subject reports.
4. Reports respect permissions and data scope.
5. Export/print buttons are permission-aware.
6. Audit logs show sensitive actions.
...
Create/update:
- docs/AI_DOS/REPORTS_IMPLEMENTATION_NOTES.md
- docs/AI_DOS/REPORTS_TESTING_CHECKLIST.md
