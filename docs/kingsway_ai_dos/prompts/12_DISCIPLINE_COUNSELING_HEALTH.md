# CODEX IMPLEMENTATION PROMPT — Discipline, Counseling, Health
...
Complete student welfare MVP: discipline cases/incidents, counseling referrals/records, health/sick-bay basic records, and restricted visibility.
...
- js/pages/*counsel*.js
- js/pages/*health*.js
- api/controllers/DisciplineController.php
- api/controllers/CounselingController.php
- api/controllers/HealthController.php
- api/modules/counseling/
- discipline, counseling, health database tables


## MVP workflows that must work

MVP workflows:
1. Authorized staff logs discipline incident.
2. Discipline lead reviews cases.
3. Counseling referral can be created where supported.
4. Health/sick-bay record can be created where supported.
5. Teacher/parent visibility is restricted appropriately.
6. Reports use real data and privacy rules.
...
Create/update:
- docs/AI_DOS/WELFARE_IMPLEMENTATION_NOTES.md
- docs/AI_DOS/WELFARE_TESTING_CHECKLIST.md

Implement:
- canonical case list/detail pages
- incident/referral creation
- sensitive-data RBAC
- audit logs
- no broad exposure of private student records
