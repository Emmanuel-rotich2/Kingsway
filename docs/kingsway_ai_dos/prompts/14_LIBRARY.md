# CODEX IMPLEMENTATION PROMPT — Library Module
...
Complete library MVP: books/resources, borrowers, issue/return, overdue tracking, and basic reports.
...
- api/modules/library/
- library/book/borrow database tables


## MVP workflows that must work

MVP workflows:
1. Librarian/admin registers book/resource.
2. Issue book to student/staff.
3. Return book.
4. View overdue/lost items.
5. Student/parent/teacher visibility is scoped.
...
Create/update:
- docs/AI_DOS/LIBRARY_IMPLEMENTATION_NOTES.md
- docs/AI_DOS/LIBRARY_TESTING_CHECKLIST.md

Implement:
- library catalogue
- issue/return workflow
- overdue report from real dates
- RBAC actions
