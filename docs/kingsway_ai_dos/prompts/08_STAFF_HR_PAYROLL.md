# CODEX IMPLEMENTATION PROMPT — Staff, HR, Payroll
...
Complete staff MVP: staff profiles, onboarding, assignments, leave, payroll preparation/approval visibility, and staff role/user linkage.
...
- api/modules/staff/
- staff, payroll, roles, users database tables
...
2. Staff is linked to user account/role where needed.
3. Assign teacher/staff duties.
4. Staff can view own profile/assignments.
5. Managers can view departmental staff.
6. Payroll is prepared and approved according to permissions.
7. Leave requests can be submitted/reviewed if present.
...
Create/update:
- docs/AI_DOS/STAFF_IMPLEMENTATION_NOTES.md
- docs/AI_DOS/STAFF_TESTING_CHECKLIST.md

Implement:
- canonical staff list/profile
- role/user linking safeguards
- staff assignment workflow
- payroll MVP endpoints/UI if schema supports it
- audit logs for onboarding/role/payroll changes
