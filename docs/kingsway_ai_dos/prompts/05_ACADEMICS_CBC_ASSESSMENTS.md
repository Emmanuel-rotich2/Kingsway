# CODEX IMPLEMENTATION PROMPT — Academics, CBC, Subjects, Classes, Assessments
...
Complete the core academic MVP: classes, streams, subjects/learning areas, teacher assignment, assessment setup, marks entry, grading, and basic report-card readiness.

## Primary files and areas to inspect first

Inspect:
- pages/manage_academics.php
- pages/manage_classes.php
- pages/manage_subjects.php
- pages/assessments_exams.php
- pages/create_assessment.php
- pages/enter_marks.php
- pages/enter_exam_results.php
- js/pages/*academic*.js
- js/pages/*assessment*.js
- api/controllers/AcademicController.php
- api/modules/academic/
- academic, classes, subjects, assessments, results database tables


## MVP workflows that must work

MVP workflows:
1. Admin/DH Academic manages academic years/terms.
2. Manage classes and streams.
3. Manage subjects/learning areas.
4. Assign class teachers and subject teachers.
5. Create assessment/exam.
6. Teacher enters marks for assigned learners only.
7. Academic lead reviews grading status.
8. Generate basic class/subject reports.
...
Create/update:
- docs/AI_DOS/ACADEMICS_IMPLEMENTATION_NOTES.md
- docs/AI_DOS/ACADEMICS_TESTING_CHECKLIST.md

Implement:
- canonical academic setup pages
- assessment CRUD
- marks entry validation
- teacher-scoped data access
- basic result aggregation using real data
- remove mock assessment/report data
