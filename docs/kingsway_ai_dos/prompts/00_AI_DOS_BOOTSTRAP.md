# CODEX IMPLEMENTATION PROMPT — AI-DOS Bootstrap and Safety Rails
...
Install the AI-DOS operating rules into the repository so future LLM runs become productive and consistent. This prompt does not complete a business module; it creates guardrails, documentation, and module execution templates used by all later prompts.
...
No user workflow implementation yet. The workflow here is engineering workflow:
- developer gives a module prompt
- agent follows constitution
- agent changes one vertical slice
...
Create/update:
- docs/AI_DOS/SYSTEM_CONSTITUTION.md
- docs/AI_DOS/ARCHITECTURE_RECOVERY_PLAN.md
- docs/AI_DOS/MODULE_EXECUTION_TEMPLATE.md
- docs/AI_DOS/DEFINITION_OF_DONE.md
- docs/AI_DOS/RBAC_STANDARD.md
- docs/AI_DOS/STATE_MANAGEMENT_STANDARD.md
- docs/AI_DOS/API_RESPONSE_STANDARD.md
- docs/AI_DOS/MVP_MODULE_ORDER.md
