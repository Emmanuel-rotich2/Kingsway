...
/* Attendance — per-page sidebar (child list + sub-tabs) */
$parentPageTitle  = 'Attendance';
$parentActive     = 'attendance';
$parentPageScript = 'parents/attendance';
$parentSidebar    = true;
    ...
    <div class="col-lg-9">
      <div class="pp-card">
        <div class="pp-card-header">
          <h1><i class="bi bi-calendar-check-fill me-2 text-success"></i><span id="ppStudentName">Attendance</span></h1>
        ...
        <div class="pp-card-body" id="ppAttendanceContent"></div>
      </div>
    </div>
  </div>
</div>
